...
trait HasAssets {
	...
	public function getAssetSource( $src ) {
		return PLUGIN_URL . '/nexcess-mapps/assets/' . $src;
	}
	 ...
	 * @param string $src       The script filename, relative to the assets folder: 'nexcess-mapps/assets'.
	 ...
	 * @param string $src     The style filename, relative to the assets folder: 'nexcess-mapps/assets'.
	 * @param array  $deps    Dependencies.
